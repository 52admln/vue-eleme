          ...
          <div class="rating-wrapper">
            <ul v-show="food.ratings && food.ratings.length">
              <li v-show="needShow(rating.rateType, rating.text)" v-for="rating in food.ratings"
                ...
                <p class="text">
                  <span
                    :class="{'icon-thumb_up': rating.rateType === 0 ,'icon-icon-thumb_down': rating.rateType === 1 }"></span>{{rating.text}}
                </p>
              </li>
            </ul>
  ...
  export default {
    ...
    methods: {
      ...
      selectRating(type) {
        ...
        // 更新 DOM 是异步的，所以需要在 nextTick 后执行
        this.$nextTick(() => {
          this.scroll.refresh();
        });
      },
...
<style lang="stylus" rel="stylesheet/stylus">
  ...
  .food
    ...
    .image-header
      ...
      height: 0
      padding-top: 100%
      /* padding-top 百分百会根据元素宽度来计算，得到一个正方形的块状元素 */
      img
        position: absolute
        top: 0
        left: 0
